...
/**
 * This interface was referenced by `TempWebsocketRootSchema`'s JSON-Schema
 * via the `definition` "ArenaEntryCondition".
 */
export type ArenaEntryCondition = "Unsafe" | "Reset" | "Safe";
/**
 * This interface was referenced by `TempWebsocketRootSchema`'s JSON-Schema
...
/**
 * This interface was referenced by `TempWebsocketRootSchema`'s JSON-Schema
 * via the `definition` "EstopMode".
 */
export type EstopMode = "NormallyOpen" | "NormallyClosed";
/**
 * This interface was referenced by `TempWebsocketRootSchema`'s JSON-Schema
 * via the `definition` "JMSCardStatus".
 */
...
/**
 * This interface was referenced by `TempWebsocketRootSchema`'s JSON-Schema
 * via the `definition` "FieldElectronicsSettingsUpdate".
 */
export type FieldElectronicsSettingsUpdate = {
  estop_mode: EstopMode;
};
/**
 * This interface was referenced by `TempWebsocketRootSchema`'s JSON-Schema
 * via the `definition` "FieldElectronicsUpdate".
 */
export type FieldElectronicsUpdate =
  | {
      SetRole: {
        mac: string;
        role: JMSRole;
...
export type WebsocketPublish =
  ...
  | {
      data: FieldElectronicsEndpoint[];
      path: "electronics/endpoints";
    }
  | {
      data: Match[];
...
export type WebsocketRpcRequest =
  ...
  | {
      ...
      path: "scoring/score_full_update";
    }
  | {
      data: null;
  ...
  | {
      data: {
        update: FieldElectronicsUpdate;
      };
      path: "electronics/update";
    }
  | {
      data: null;
      path: "electronics/reset_estops";
    }
  | {
      data: null;
      path: "electronics/settings";
    }
  | {
      data: {
        update: FieldElectronicsSettingsUpdate;
      };
      path: "electronics/update_settings";
    }
  | {
      data: {
        match_id: string;
  ...
  | {
      data: {
        condition: ArenaEntryCondition;
      };
      path: "arena/set_entry_condition";
    }
  | {
      data: {
        match_id: string;
...
export interface LiveScore {
  ...
  coop_adjust: boolean;
  endgame: EndgameType[];
  ensemble_adjust: boolean;
  leave: boolean[];
  melody_adjust: boolean;
  microphones: boolean[];
  notes: LiveNotes;
  penalties: Penalties;
  traps: boolean[];
...
export interface DerivedScore {
  ...
  endgame_harmony_points: number;
  endgame_onstage_points: number;
  endgame_park_points: number;
  endgame_points: number;
  endgame_spotlit_bonus_points: number;
  endgame_trap_points: number;
  ensemble_rp: boolean;
  foul_score: number;
  leave_points: number;
  melody_rp: boolean;
...
/**
 * This interface was referenced by `TempWebsocketRootSchema`'s JSON-Schema
 * via the `definition` "FieldElectronicsEndpoint".
 */
export interface FieldElectronicsEndpoint {
  mac: string;
  status: JMSElectronicsStatus;
}
/**
 * This interface was referenced by `TempWebsocketRootSchema`'s JSON-Schema
 * via the `definition` "JMSElectronicsStatus".
 */
...
/**
 * This interface was referenced by `TempWebsocketRootSchema`'s JSON-Schema
 * via the `definition` "FieldElectronicsSettings".
 */
export interface FieldElectronicsSettings {
  estop_mode: EstopMode;
}
/**
 * This interface was referenced by `TempWebsocketRootSchema`'s JSON-Schema
...
/**
 * This interface was referenced by `TempWebsocketRootSchema`'s JSON-Schema
 * via the `definition` "ScoringConfig".
 */
export interface ScoringConfig {
  amp_auto_points: number;
  amp_teleop_points: number;
  ensemble_points_threshold: number;
  ensemble_stage_count_threshold: number;
  foul_points: number;
  harmony_points: number;
  harmony_threshold: number;
  leave_points: number;
  melody_threshold: number;
  melody_threshold_coop: number;
