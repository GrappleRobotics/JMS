...
export default function TBAIntegration() {
  ...
  return <React.Fragment>
    ...
    that your offseason is listed on TBA, and that you have API write keys, which should be requested prior to your event. You can request
    ...
    { settings && <React.Fragment>
      ...
      <Row className="mt-3">
        <Col>
          <Button size="lg" variant="success" onClick={() => call<"tba/update_now">("tba/update_now", null).catch(addError)}>
            Update Now
          </Button>
        </Col>
      </Row>
